...
//    cableLengthPortH = 1.0;
    ...
    saveDigitalOutputs = new BooleanItem("SaveDigitalOutputs", "DigitalOutputs", "save", this, true); // TEMP, DEBUG
    saveDigitalOutputs->setRestricted(RestrictIfRunning, "cannot be set while board is running");

    saveDCAmplifierWaveforms = new BooleanItem("SaveDCAmplifierWaveforms", "DCAmplifierWaveforms", "save", this, false);
    ...
    saveTriggerSource = new BooleanItem("TriggerSave", "Trigger", "saveSource", this, true);
    ...
    audioEnabled = new BooleanItem("AudioEnabled", "Audio", "enabled", this, false);
    audioVolume = new IntRangeItem("AudioVolume", this, 0, 100, 50);
    audioThreshold = new IntRangeItem("AudioThreshold", this, 0, 200, 0);

    // TCP communication
    globalTcpDataOutputEnabled = new BooleanItem("TCPDataOutputEnabled", "TCPDataOutput", "enabled", this, false);
    ...
    showDisabledChannels = new BooleanItem("ShowDisabledChannels", "ShowWaveforms", "disabledChannels", this, true);
    showAuxInputs = new BooleanItem("ShowAuxInputs", "ShowWaveforms", "auxInputs", this, true);
    showSupplyVoltages = new BooleanItem("ShowSupplyVoltages", "ShowWaveforms", "supplyVoltages", this, false);

    // Plotting waveforms
<<<<<<< HEAD
    rollMode = new BooleanItem("RollMode", "Plot", "rollMode", this, true);
=======
    rollMode = new BooleanItem("RollMode", this, true);
    clipWaveforms = new BooleanItem("ClipWaveforms", this, false);
>>>>>>> 40591c9dbcbe35b7666c53e475111474e1f6365b
    ...
    yAxisLogISI = new BooleanItem("ISIYAxisLog", "ISI", "yAxisLog", this, false);

    saveCsvFileISI = new BooleanItem("ISISaveCsvFile", "ISI", "saveCsvFile", this, true);
    saveMatFileISI = new BooleanItem("ISISaveMatFile", "ISI", "saveMatFile", this, true);
    savePngFileISI = new BooleanItem("ISISavePngFile", "ISI", "savePngFile", this, true);
    ...
    saveCsvFilePSTH = new BooleanItem("PSTHSaveCsvFile", "PSTH", "saveCsvFile", this, true);
    saveMatFilePSTH = new BooleanItem("PSTHSaveMatFile", "PSTH", "saveMatFile", this, true);
    savePngFilePSTH = new BooleanItem("PSTHSavePngFile", "PSTH", "savePngFile", this, true);
    ...
    showFMarkerSpectrogram = new BooleanItem("SpectrogramShowFreqMarker", "Spectrogram", "showFreqMarker", this, true);
    ...
    saveCsvFileSpectrogram = new BooleanItem("SpectrogramSaveCsvFile", "Spectrogram", "saveCsvFile", this, true);
    saveMatFileSpectrogram = new BooleanItem("SpectrogramSaveMatFile", "Spectrogram", "saveMatFile", this, true);
    savePngFileSpectrogram = new BooleanItem("SpectrogramSavePngFile", "Spectrogram", "savePngFile", this, true);
    ...
    suppressionEnabled = new BooleanItem("ArtifactSuppressionEnabled", "SpikeScope", "suppressArtifacts", this, true);
    artifactsShown = new BooleanItem("ArtifactsShown", "SpikeScope", "showArtifacts", this, true);
