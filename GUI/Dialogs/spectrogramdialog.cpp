    ...
    state(state_)
{
    ...
    connect(displayModeButtonGroup, SIGNAL(buttonClicked(QAbstractButton*)), this, SLOT(changeDisplayMode()));
...
void SpectrogramDialog::changeDisplayMode()
{
    int index = displayModeButtonGroup->checkedId();
